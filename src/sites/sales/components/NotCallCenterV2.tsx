        ...
        <div className="mx-auto max-w-[1400px] px-6 md:px-12 lg:px-20">
          ...
          <div className="mt-16 md:mt-24 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-lg text-background/60">Volume of calls</span>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-background/5 flex items-center justify-center">
                    <svg className="w-5 h-5 text-background/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <span className="text-lg text-background/60">Standard scripts</span>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-background/5 flex items-center justify-center">
                    <svg className="w-5 h-5 text-background/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <span className="text-lg text-background/60">Phone only</span>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-background/5 flex items-center justify-center">
                    <svg className="w-5 h-5 text-background/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <span className="text-lg text-background/60">Activity KPIs</span>
                </div>
              </div>
              ...
              <div className="mt-10 p-6 rounded-lg bg-background/5 border border-background/10">
                ...
                <p className="text-sm text-background/30 mt-1">calls made</p>
                <div className="mt-4 flex items-center gap-2">
                  <span className="text-sm text-background/40">???</span>
                  <span className="text-xs text-background/30">pipeline generated</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-3">
                {["ICP Strategy", "Enriched Data", "Multi-channel", "Trained B2B SDRs", "Custom Playbooks", "Business Qualification"].map((item, i) => (
                  <motion.div
                    key={item}
              ...
              >
                ...
                <p className="text-sm text-background/60 mt-1">pipeline generated</p>
                <div className="mt-4 flex items-center gap-2">
                  <span className="text-sm text-accent">31</span>
                  <span className="text-xs text-background/50">qualified meetings</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
          ...
          >
            <p className="text-2xl md:text-3xl lg:text-4xl font-semibold">
              <span className="text-background/40">Volume is activity.</span>
            </p>
            <p className="text-2xl md:text-3xl lg:text-4xl font-semibold mt-2">
              <span className="text-accent">Pipeline is the outcome.</span>
            </p>
          </motion.div>
        </div>
      </div>
